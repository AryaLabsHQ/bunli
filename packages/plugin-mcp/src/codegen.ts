 ...
 */
function jsonSchemaTypeToTS(type: string, enumValues?: Array<string | number>): string {
  // Handle enum
 ...
 */
function generateModuleAugmentation(namespace: string, metadata: MCPCommandMetadata[]): string {
  const lines: string[] = [];
