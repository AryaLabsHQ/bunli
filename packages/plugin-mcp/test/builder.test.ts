...
describe("CommandBuilder", () => {
  ...
  describe("fluent API", () => {
    test("namespace() sets namespace prefix", () => {
      const commands = Commands.from(sampleTools).namespace("exa").commands();
  ...
  describe("registrations()", () => {
    ...
    test("respects namespace in variable names", () => {
      const registrations = Commands.from(sampleTools).namespace("exa").registrations();
  ...
  describe("edge cases", () => {
    ...
    test("handles tools without inputSchema", () => {
      const tools: MCPTool[] = [{ name: "simple_action", description: "A simple action" }];
