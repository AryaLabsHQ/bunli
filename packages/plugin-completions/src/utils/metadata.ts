...
export async function resolveCliInfo(
  options: CompletionsPluginOptions = {},
): Promise<ResolvedCliInfo> {
...
async function readProjectPackageJson(): Promise<
  Result<Record<string, unknown>, PackageJsonReadError>
> {
