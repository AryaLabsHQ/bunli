...
test("BunliPlugin hooks are optional", () => {
  ...
  expectTypeOf(plugin.setup).toEqualTypeOf<
    ((context: PluginContext) => void | Promise<void>) | undefined
  >();
...
test("postRun hook receives CommandContext & CommandResult and ExecutionState", () => {
  ...
  expectTypeOf<Parameters<PostRun>>().toEqualTypeOf<
    [CommandContext<any> & CommandResult, ExecutionState]
  >();
});
