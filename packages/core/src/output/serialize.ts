...
export type SerializedOptionValidationCliError = SerializedTaggedErrorBase<OptionValidationError> & {
...
export type SerializedCommandExecutionCliError = SerializedTaggedErrorBase<CommandExecutionError> & {
...
function serializeTaggedErrorBase<E extends KnownCliTaggedError>(error: E): SerializedTaggedErrorBase<E> {
  return {
    name: error.name,
    tag: error._tag,
...
function serializeKnownCliTaggedError(error: KnownCliTaggedError): Exclude<
  SerializedCliError,
