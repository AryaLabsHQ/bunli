...
describe("@bunli/tui shell primitives", () => {
  ...
  test("SidebarLayout resolves responsive modes from terminal width", () => {
    expect(resolveSidebarLayoutMode(150, "auto", { mediumMinWidth: 100, wideMinWidth: 132 })).toBe(
      "wide",
    );
    expect(resolveSidebarLayoutMode(112, "auto", { mediumMinWidth: 100, wideMinWidth: 132 })).toBe(
      "medium",
    );
    expect(resolveSidebarLayoutMode(88, "auto", { mediumMinWidth: 100, wideMinWidth: 132 })).toBe(
      "narrow",
    );
  });
