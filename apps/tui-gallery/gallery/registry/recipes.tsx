      ...
      entries: [
        {
          ...
          states: [
            ...
            { key: 'choose', label: 'Choose-enabled', description: 'Choose flow with more options' }
          ],
          sourceRefs: [
      ...
      entries: [
        {
          ...
          summary: 'A focused recipe showing how form primitives become a workflow rather than a standalone component demo.',
          usage: [
          ...
          states: [
            ...
            { key: 'production', label: 'Production', description: 'Guardrailed production profile' }
          ],
          sourceRefs: [
      ...
      entries: [
        {
          ...
          summary: 'CommandPalette driven by runtime-registered commands rather than a hard-coded item list.',
          usage: [
          ...
          sourceRefs: [
            { label: 'Command registry', path: 'packages/runtime/src/runtime/command-registry.tsx' },
      ...
      entries: [
        {
          ...
          sourceRefs: [{ label: 'Route store', path: 'packages/runtime/src/runtime/route-store.tsx' }],
