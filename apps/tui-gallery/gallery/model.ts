...
export function findSection(sections: GallerySection[], sectionId: GallerySectionId): GallerySection | null {
  return sections.find((section) => section.id === sectionId) ?? null
}

export function findCategory(sections: GallerySection[], categoryId: string): GalleryCategory | null {
