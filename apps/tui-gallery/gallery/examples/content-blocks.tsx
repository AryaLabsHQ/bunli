...
export function ContentBlocksExample({ stateKey }: GalleryRenderContext) {
  ...
  if (stateKey === 'diff') {
    return (
      <Stack gap={1}>
        ...
        <Card title='Config Diff' description='Before/after summary for a generated file' tone='warning' emphasis='outline'>
          <Diff
  ...
  return (
    <Stack gap={1}>
      ...
      <Card title='Helper Primitives' description='Static content blocks with intentional formatting' tone='accent' emphasis='outline'>
        <List
          items={[
