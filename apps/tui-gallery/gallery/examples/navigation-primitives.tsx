import { CommandPalette, DataTable, KeyValueList, Menu, Stack, Tabs } from "@bunli/tui/interactive";
      ...
      <Tabs
        ...
        tabs={[
          ...
          },
          {
            ...
            label: "Detail",
            content: (
              <text content="Tabs are useful for small in-place mode switches inside a single route." />
            ),
          },
          {
            key: "history",
            label: "History",
            content: (
              <text content="Keep tab content focused; for bigger transitions prefer route changes." />
            ),
          },
        ]}
      />
