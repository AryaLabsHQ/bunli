    ...
    return (
      <Stack gap={1}>
        <Panel
          ...
          subtitle="Tone + emphasis communicate status fast"
          tone="accent"
        >
  ...
  return (
    <Stack gap={1}>
      <Alert
        ...
        message="All packages built successfully and are ready for release."
      />
      <Alert
        tone="warning"
        title="Compatibility"
        message="This release introduces a small API rename in the navigation primitives."
      />
      <EmptyState
