...
- **[Plugins Core Concept](/docs/core-concepts/plugins)** - Deep dive into plugin system
- **[Configuration Guide](/docs/guides/schema-validation)** - Configuration patterns
- **[Testing Guide](/docs/guides/testing)** - Testing strategies for long-running processes
- **[Interactive Prompts Guide](/docs/guides/interactive-prompts)** - Real-time user interactions
