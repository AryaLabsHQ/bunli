...
- [Terminal UI Guide](/docs/guides/terminal-ui) - Deep dive into React UI
- [Real-World Example](/docs/examples/real-world) - Complete production example
- [Interactive Prompts Guide](/docs/guides/interactive-prompts) - Traditional prompts
- [@bunli/ui](/docs/packages/ui) - UI components reference
- [@bunli/renderer](/docs/packages/renderer) - Renderer documentation