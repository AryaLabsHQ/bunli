...
<Tabs groupId="package-manager" defaultValue="bun">
  <Tab value="bun" label="Bun">
    ```bash # Create a new CLI project bunx create-bunli my-cli cd my-cli # Start development bunli
    dev # Build for production bunli build ```
  </Tab>
  <Tab value="npm" label="npm">
    ```bash # Create a new CLI project npx create-bunli my-cli cd my-cli # Start development npm run
    dev # Build for production npm run build ```
  </Tab>
</Tabs>
...
<Cards>
  ...
  />
  <Card title="Examples" description="See Bunli in action" href="/docs/examples/hello-world" />
  <Card title="API Reference" description="Explore the full API" href="/docs/api/create-cli" />
</Cards>
