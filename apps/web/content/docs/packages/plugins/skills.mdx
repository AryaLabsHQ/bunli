...
For programmatic access to agent detection and skill generation:
...
import {
  ...
  detectAgents,
  generateSkillFile,
  generateCommandSkill,
  syncSkills,
} from "@bunli/plugin-skills";

// Get all supported agents (built-in + custom)
const allAgents = builtinAgents;

// Detect which agents are installed on the system
const detected = detectAgents();

// Generate skill file content for a command
