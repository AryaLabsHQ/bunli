...
Create a test plugin for development and testing purposes. Useful when writing tests for plugin hooks.
...
Compose multiple plugins into a single plugin, merging their stores.
