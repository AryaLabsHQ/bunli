...
interface PluginContext {
  /** Current configuration (being built; use updateConfig to accumulate changes) */
  config: BunliConfigInput;

  /** Update configuration with additional values */
  updateConfig(partial: BunliConfigInput): void;
