...
Bunli can compile your CLI into standalone executables that don't require Bun to be installed:
...
bunli build --compile --platform darwin-arm64

# Compile with optimization
bunli build --compile --minify --bytecode
```
...
# Verify signature
codesign --verify --verbose dist/my-cli
```
