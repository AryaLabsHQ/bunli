...
<Callout type="info">
  Generated type files are automatically included in your distribution builds. No additional
...
<Callout type="warning">Keep `build.compress` disabled when using `bunli-releaser`.</Callout>
