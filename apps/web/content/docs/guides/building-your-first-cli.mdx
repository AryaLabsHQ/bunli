...
- [hello-world](https://github.com/AryaLabsHQ/bunli/tree/main/examples/hello-world) - Minimal CLI with TUI
- [task-runner](https://github.com/AryaLabsHQ/bunli/tree/main/examples/task-runner) - Validation + interactivity
- [git-tool](https://github.com/AryaLabsHQ/bunli/tree/main/examples/git-tool) - Command organization + shell
- [dev-server](https://github.com/AryaLabsHQ/bunli/tree/main/examples/dev-server) - Plugin system
