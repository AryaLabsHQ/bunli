...
Let's create a simple todo list CLI. Replace the greet command with a new `add` command:
...
```bash
bun cli.ts add --task "Write documentation" --priority high
```
...
Find the complete hello-world CLI example in the [Bunli repository](https://github.com/AryaLabsHQ/bunli/tree/main/examples/hello-world).
