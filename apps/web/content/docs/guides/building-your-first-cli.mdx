...
Find the complete examples in the [Bunli repository](https://github.com/AryaLabsHQ/bunli/tree/main/examples):
- [hello-world](https://github.com/AryaLabsHQ/bunli/tree/main/examples/hello-world) - Minimal TUI-based CLI
- [task-runner](https://github.com/AryaLabsHQ/bunli/tree/main/examples/task-runner) - Interactive prompts and project creation
- [dev-server](https://github.com/AryaLabsHQ/bunli/tree/main/examples/dev-server) - Plugin system and metrics
