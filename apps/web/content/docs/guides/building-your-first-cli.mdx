...
<Callout type="tip">
  Type generation provides autocomplete, type safety, and enables advanced patterns like CLI
  wrappers and documentation generation.
</Callout>
...
Find the complete working examples in the [Bunli repository](https://github.com/AryaLabsHQ/bunli/tree/main/examples):
- [hello-world](https://github.com/AryaLabsHQ/bunli/tree/main/examples/hello-world) - Basic CLI structure
- [task-runner](https://github.com/AryaLabsHQ/bunli/tree/main/examples/task-runner) - Task automation
- [git-tool](https://github.com/AryaLabsHQ/bunli/tree/main/examples/git-tool) - Git workflow helper
- [dev-server](https://github.com/AryaLabsHQ/bunli/tree/main/examples/dev-server) - Development server
