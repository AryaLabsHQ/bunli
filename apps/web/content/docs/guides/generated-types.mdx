...
export function getCommandApi(name: string): GeneratedCommandMeta | undefined
export function getTypedFlags<T extends string>(name: T): CommandOptions<T>
export function validateCommand(name: string, flags: any): ValidationResult
