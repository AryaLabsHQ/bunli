/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: e64676da814810edd040c8f640157277)
// Runtime types generated with workerd@1.20260210.0 2026-02-11 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "Sandbox" | "WorkbenchLimiter";
	}
	interface Env {
		...
		WORKBENCH_LIMITER: DurableObjectNamespace<import("./src/server").WorkbenchLimiter>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_API_TOKEN" | "SITE_URL" | "BETTER_AUTH_BASE_URL" | "BETTER_AUTH_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "WORKBENCH_WORKSPACE_DIR" | "WORKBENCH_BUN_VERSION" | "WORKBENCH_BUNLI_VERSION" | "WORKBENCH_SANDBOX_NETWORK">> {}
}
